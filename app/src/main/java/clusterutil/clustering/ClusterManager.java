...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public DefaultClusterRenderer<T> mRenderer2;
    ...
    public ClusterManager(Context context, BaiduMap map, MarkerManager markerManager) {
        ...
        mRenderer2 = (DefaultClusterRenderer<T>) mRenderer;
    ...
    public void cluster() {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                ...
                LogUtil.d("ClusterManager", "mMap:" + mMap + "~~~~mMap.getMapStatus():" + mMap.getMapStatus() + "~~~ mMap.getMapStatus().zoom:+" + mMap.getMapStatus().zoom);
