...
package com.jld.torsun.barcode.camera;
...
public final class CameraManager {
    ...
    private static int MIN_FRAME_WIDTH = 243;
    private static int MIN_FRAME_HEIGHT = 243;
    private static int MAX_FRAME_WIDTH = 243;
    private static int MAX_FRAME_HEIGHT = 243;
...
//                    height + 216 + 137);
            int topOffset = DensityUtil.dip2px(context, 46 + 72);
