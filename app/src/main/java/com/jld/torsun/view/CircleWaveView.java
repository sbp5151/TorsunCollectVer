...
public class CircleWaveView extends View implements Runnable {
    ...
    private int waveColor = Color.argb(255, 255, 250, 250); // 颜色
    private int waveInterval = 25; // 圆环的宽度
...
//    }
    ...
    private void initView() {
        ...
        float density = displayMetrics.density;
        LogUtil.d("density", "density:" + density);
        waveInterval = (int) (density * waveInterval);
    ...
    private void init() {
        ...
        if (mWidth >= mHeight) {
            maxRadius = mHeight / 2.2F;
        } else {
            maxRadius = mWidth / 2.2F;
        }
