...
public class ScrListView extends ListView
{
	 ...
	 * @param attrs
	 */
	public ScrListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		View view = mInflater.inflate(R.layout.item_delete_btn_layout, null);
		mDelBtn = (Button) view.findViewById(R.id.btn_trouteam_item_delete);
